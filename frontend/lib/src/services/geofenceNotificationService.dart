...
class GeofenceNotificationService {
  ...
  static Future<void> init() async {
    ...
    await _notifications.initialize(
      ...
      onDidReceiveNotificationResponse: (response) {
        ...
        try {
          Get.to(() => const Mapa()); // Exemplo de navegação
  ...
  //     'geofence_channel', // ID do canal
  //     'Geofencing', // Nome do canal
  //     channelDescription: 'Notificações de geofencing',
  ...
  Future<void> mostrarNotificacao(String titulo, String corpo) async {
