...
class EditarPerfilCuidadorSecundario extends StatelessWidget {
  const EditarPerfilCuidadorSecundario({super.key, required this.idCuidSec});

  final String idCuidSec;
  ...
  Widget build(BuildContext context) {
    ...
    final CuidadoresSecundariosController cuidadoresController =
        Get.put(CuidadoresSecundariosController());

    return FutureBuilder<CuidadoresSecundarios>(
        future: cuidadoresController.getCuidadorSecundario(idCuidSec),
        builder: (BuildContext context,
            AsyncSnapshot<CuidadoresSecundarios> snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            CuidadoresSecundarios cuidador = snapshot.data!;
                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  CuidadoresSecundarios cuidador =
